...
// iOS skin definitions — SkinRarity.color returns SwiftUI Color for iOS views.
// bodyColor/accentColor return SKColor (= UIColor on iOS) for the game engine.
// watchOS uses SkinDefinition.swift instead.
...
enum SkinRarity: String, Codable, CaseIterable {
    case common, rare, ultraRare, epic, legendary
    ...
    // SwiftUI Color for iOS views
    var color: Color {
        switch self {
        case .common:    return Color(r: 0xA0, g: 0xA0, b: 0xA0)
        case .rare:      return Color(r: 0x34, g: 0x98, b: 0xDB)
        case .ultraRare: return Color(r: 0x9B, g: 0x59, b: 0xB6)
        case .epic:      return Color(r: 0xF1, g: 0xC4, b: 0x0F)
        case .legendary: return Color(r: 0xFF, g: 0x14, b: 0x93)
        }
    }

    // SKColor (= UIColor on iOS) for game engine drawing
    var skColor: SKColor {
        switch self {
...
enum AnimalSkin: String, Codable, CaseIterable {
    // Common
    ...
    // Legendary (Sanrio)
    case helloKitty, myMelody, cinnamoroll, kuromi, pompompurin, keroppi, pochacco, badtzMaru, tuxedoSam, littleTwinStars, blueTwinStar
    ...
    // SKColor body color for game engine drawing
    ...
    // SKColor accent color for game engine drawing
